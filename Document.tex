...
\newcommand{\removeText}[1]{\textcolor{red}{#1}}
\newcommand{\addText}[1]{\textcolor{blue}{#1}}
...
\include{CHAPTERS/0-Definitions_Etudiant}
...
\hypersetup{
  ...
  colorlinks=false,
  pdfborder={0 0 1},
  linkbordercolor={0 0 1},   % blue boxes for refs/TOC
  citebordercolor={0 0.6 0}, % green boxes for citations
  urlbordercolor={0.6 0 0}   % red boxes for URLs
}
...
\include{CHAPTERS/1-Dedicace}          % Dédicace du document.
\include{CHAPTERS/2-Remerciements}     % Remerciements / Acknowledments
\include{CHAPTERS/3-Resume_sujet}      % Résumé du sujet en français / Abstract in French
\include{CHAPTERS/3-Abstract}          % Résumé du sujet en anglais / Abstract in English
...
\include{CHAPTERS/4-Sigles_Abrev}       % Liste des sigles et abréviations.
\ifthenelse{\equal{\AnnexesPresentes}{O}}{\listofappendices}{}
\mainmatter
\include{CHAPTERS/5-Introduction}       % Introduction au sujet de recherche.
\include{CHAPTERS/6-Revue_litterature}  % Revue de littérature / Literature review
%\include{CHAPTERS/7-CHAPTER_THESIS_STRUCTURE}  % Revue de littérature / Literature review

\include{CHAPTERS/7-CHAPTER_LAGRANGIAN}

\include{CHAPTERS/7-CHAPTER_LEVEL_SET}
\include{CHAPTERS/7-CHAPTER_IBM}
\include{CHAPTERS/7-CHAPTER_DISCUSSIONS}
