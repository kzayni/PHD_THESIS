...
\caption{Parallel scalability of the Lagrangian solver: speedup and parallel efficiency relative to the two-node baseline.}
...
\caption{Collection-efficiency results for Case IPW1-112: impact-zone treatment, droplet-size distribution, Eulerian--Lagrangian comparison, and SLD-model assessment.}
\label{fig:Impinge}
\end{figure}
...
\caption{Collection-efficiency results for Case IPW1-122. The upper row compares Eulerian and Lagrangian impingement predictions; the lower row assesses the SLD models and secondary-droplet re-impingement.}
\label{fig:MDA}
\end{figure}
...
\begin{figure}[p]
\centering
\subfloat[Case geometry.]{%
    \includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/GEO.png}%
    \label{fig:CASE_1p3_GEO}%
}%
\hfill
\subfloat[Gap between the model and the wind-tunnel wall.]{%
    \includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/GAP.png}%
    \label{fig:CASE_1p3_GAP}%
}%
\hfill
\subfloat[Relative difference between the Eulerian and Lagrangian solutions.]{%
    \includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/difference.png}%
    \label{fig:CASE_1p3_Contour}%
}%

\medskip

\subfloat[Station 1: 18 inches.]{%
    \includegraphics[trim={0cm 0.05cm 0.05cm 0cm},clip,width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_1p3_18IN.eps}%
    \label{fig:CASE_1p3_18}%
}%
\hfill
\subfloat[Station 2: 36 inches.]{%
    \includegraphics[trim={0cm 0.05cm 0.05cm 0cm},clip,width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_1p3_36IN.eps}%
    \label{fig:CASE_1p3_36}%
}%
\hfill
\subfloat[Station 3: 54 inches.]{%
    \includegraphics[trim={0cm 0.05cm 0.05cm 0cm},clip,width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_1p3_54IN.eps}%
    \label{fig:CASE_1p3_54}%
}%
\caption{Case IPW2-1.3 geometry and Eulerian--Lagrangian collection-efficiency comparison at the three measurement stations and over the full surface.}
...
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_FUSELAGE_DISTRIBUTION.eps}
\label{fig:CRM_FUSELAGE}%
}%
\hfill
\subfloat[\centering Impingement results on the Wing-1.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_1_DISTRIBUTION.eps}
\label{fig:CRM_WING_1}%
}
\hfill
\subfloat[\centering Impingement results on the Wing-2.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_2_DISTRIBUTION.eps}
...
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_3_DISTRIBUTION.eps}
\label{fig:CRM_WING_3}%
}%
\hfill
\subfloat[\centering Impingement results on the Wing-4.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_4_DISTRIBUTION.eps}
\label{fig:CRM_WING_4}%
}
\hfill
\subfloat[\centering Impingement results on the Wing-5.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_5_DISTRIBUTION.eps}
\label{fig:CRM_WING_5}%
}
\caption{Collection-efficiency results for Case HLPW5-2.1 at the fuselage and five spanwise wing cuts.}
\label{fig:2p1}
\end{figure}
\end{landscape}
...
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_FUSELAGE_SLD.eps}
\label{fig:CRM_FUSELAGE_SLD}%   
}%
\hfill
\subfloat[\centering SLD results on the Wing-1.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_1_SLD.eps}
\label{fig:CRM_WING_1_SLD}%
}
\hfill
\subfloat[\centering SLD results on the Wing-2.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_2_SLD.eps}
...
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_3_SLD.eps}
\label{fig:CRM_WING_3_SLD}%
}%
\hfill
\subfloat[\centering SLD results on the Wing-4.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_4_SLD.eps}
\label{fig:CRM_WING_4_SLD}%
}
\hfill
\subfloat[\centering SLD results on the Wing-5.]{%
\includegraphics[width=0.31\linewidth]{FIGURES/LAGRANGIAN_ARTICLE/CASE_2p1_WING_5_SLD.eps}
\label{fig:CRM_WING_5_SLD}%
}
\caption{SLD-model results for Case HLPW5-2.1 at the fuselage and five spanwise wing cuts.}
\label{fig:2p1_sld}
\end{figure}
\end{landscape}
...
\begin{figure}[!htbp] 
    ...
    \caption{Locations of the collection-efficiency cuts on the CRM wing and fuselage.}
    \label{fig:cuts}
\end{figure}
